...
import net.cama.gravityapivs.item.GravityChangerItem;
import net.cama.gravityapivs.item.GravityChangerItemAOE;
...
public class GravityItems
{
    ...
    public static final RegistryObject<Item> STICKY_CHEST = ITEMS.register("sticky_chest", () -> new net.cama.gravityapivs.sticky.StickyChestItem(GravityBlocks.STICKY_CHEST.get(), new Properties()));
