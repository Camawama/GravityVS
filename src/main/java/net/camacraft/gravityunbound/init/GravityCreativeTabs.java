...
public class GravityCreativeTabs
{
    ...
    public static final RegistryObject<CreativeModeTab> GRAVITY_API = CREATIVE_MODE_TAB.register("gravityunbound", () -> CreativeModeTab.builder()
    		.title(Component.translatable("itemGroup.gravityunbound"))
    		...
    		.displayItems((enabledFeatures, output) -> 
    		{
                ...
                output.accept(new ItemStack(GravityItems.STICKY_CHEST.get()));
