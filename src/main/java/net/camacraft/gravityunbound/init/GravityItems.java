...
import net.camacraft.gravityunbound.item.GravityChangerItem;
import net.camacraft.gravityunbound.item.GravityChangerItemAOE;
import net.camacraft.gravityunbound.plating.GravityPlatingItem;
...
public class GravityItems
{
    ...
    public static final RegistryObject<Item> GRAVITY_NORMALIZER = ITEMS.register("gravity_normalizer", () -> new net.minecraft.world.item.BlockItem(GravityBlocks.GRAVITY_NORMALIZER.get(), new Properties()));

    public static final RegistryObject<Item> STICKY_CHEST = ITEMS.register("sticky_chest", () -> new net.camacraft.gravityunbound.sticky.StickyChestItem(GravityBlocks.STICKY_CHEST.get(), new Properties()));

    public static final RegistryObject<Item> STICKY_CASTER = ITEMS.register("sticky_caster", () -> new net.camacraft.gravityunbound.sticky.StickyCasterItem(GravityBlocks.STICKY_MIMIC.get(), new Properties().stacksTo(1)));

    public static final RegistryObject<Item> STICKY_RAIL = ITEMS.register("sticky_rail", () -> new net.minecraft.world.item.BlockItem(GravityBlocks.STICKY_RAIL.get(), new Properties()));
